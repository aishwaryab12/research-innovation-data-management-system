...
<script src = "./Validation_Files/professionalmembership_verify1.js"></script>
...
<div class="jumbotron">
<center><h1>Professional Membership</h1></center>

	<form class="form-horizontal" name="forms" onsubmit = "return validate()"  method="post" action="professionalmembershipProcess.jsp">
...
<option>	Ms.Rupali Bhondave	</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Name of the body/ agency</label><br>
			<input type="text" class="form-control" name="nameofbodyagency" required="required" placeholder="" /> <br>
			</div>
		</div>
		...
		<div class="row content">
			...
			<option disabled selected value>-----Choose option-----</option>
				...
				<option>Fellow Life Member</option>
			</select>
			</div>
		</div>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Membership Period</label><br>
					<div class="row content">
					
							<div class="col-md-6 ">
							<label><font style="color: red;">*</font>From</label><br>
								<input type="date" class="form-control" name="membershipfrom" required="required" placeholder="" /> <br>
							</div>
							
							<div class="col-md-6 ">
							<label><font style="color: red;">*</font>To</label><br>
								<input type="date" class="form-control" name="membershipto" required="required" placeholder="" /> <br>
							</div>
					</div>
		...
		<!--<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Membership Details</label><br>
			<input type="text" class="form-control" name="membershipdetails" required="required" placeholder="" /> <br>
			</div>
		</div>-->
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Membership Number</label><br>
			<input type="text" class="form-control" name="membershipnumber" id="membershipnumber"  required="required" placeholder="" />
			<font style="color: red;"><span id="membershipnumbererror"></span></font>
			</div>
		</div>
