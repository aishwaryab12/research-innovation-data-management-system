...
<script src = "./Validation_Files/bookchapterpublished_verify1.js"></script>
<title>Details of Book Chapters Published</title>
</head>
<body>
...
<div class="jumbotron">
<center><h1>Book Chapters Published</h1></center>

	<form class="form-horizontal" onsubmit = "return validate()" name="forms" method="post" action="bookchapterpublishedProcess.jsp">
...
<option>	Ms.Rupali Bhondave	</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Chapter Number</label><br>
			<input type="text" class="form-control" name="chapternumber" required="required" placeholder="" /> <br>
			</div>
		</div>
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Name of Book Chapter</label><br>
			<input type="text" class="form-control" name="nameofbookchapter" required="required" placeholder="" /> <br>
			</div>
		</div>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>No. Of Pages</label><br>
			<input type="text" class="form-control" name="noofpages" id="noofpages" required="required" placeholder="" />
			<font style="color: red;"><span id="noofpageserror"></span></font>
			</div>
		</div>
