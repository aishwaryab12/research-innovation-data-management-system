...
<div class="jumbotron">
<center><h1>Research Awards</h1></center>

	<form class="form-horizontal" name="forms" method="post" action="researchawardsProcess.jsp">
...
<option>	Ms.Rupali Bhondave	</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				...
				<select class="form-control" name="typeofaward" required="required">
					<option disabled selected value>-----Choose option-----</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Title of Award</label><br>
			<input type="text" class="form-control" name="titleofaward" required="required" placeholder="" /> <br>
			</div>
		</div>
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Awarded By</label><br>
			<input type="text" class="form-control" name="awardedby" required="required" placeholder="" /> <br>
			</div>
		</div>
