...
<title>Recognitions Received</title>
</head>
<body>
...
<div class="jumbotron">
<center><h1>Recognitions Received</h1></center>

	<form class="form-horizontal" name="forms" method="post" action="recognitionsProcess.jsp">
		
		 <div class="row content">
			<div class="col-md-6 ">
				<label>Name Of Department<font style="color: red;">*</font></label><br>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Type Of Award</label><br>
				<select class="form-control" name="typeofaward" required="requried">
					<option disabled selected value>-----Choose option-----</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Recognition as</label><br>
				<select class="form-control" name="recognitionas" required="requried">
					<option disabled selected value>-----Choose option-----</option>
					<option>Editorial Board Member</option>
					<option>Chief Editor</option>
					<option>Advisory Member</option>
				</select>
			</div>
		</div>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Name Of Professional Body or Agency</label><br>
			<input type="text" class="form-control" name="nameofprofessionalbody" required="required" placeholder="" /> <br>
			</div>
		</div>
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>URL</label><br>
			<input type="text" class="form-control" name="url" required="required" placeholder="" /> <br>
			</div>
		</div>
