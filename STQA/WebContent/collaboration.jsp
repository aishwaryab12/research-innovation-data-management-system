...
<title>Interaction with outside world</title>
</head>
<body>
...
<center><h1>Collaborations</h1></center>
	...
	<form class="form-horizontal" name="forms"  method="post" action="collaborationProcess.jsp">
...
<option>	Ms.Rupali Bhondave	</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Interaction with outside world as </label>
			<select class="form-control" name="interactiontype" required="required">
				<option disabled selected value>----Choose Option----</option>
		...
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Topics </label><br>
				<textarea class="form-horizontal" name="topics"rows=3 placeholder="" required="required"></textarea><br /><br>
			</div>
		</div>
		...
		<div class="row content">
			...
			<select class="form-control" name="targetaudience" required="required">
			<option disabled selected value>----Choose Option----</option>
				<option>Faculty</option>
				<option>Student</option>
				<option>Researcher</option>
				<option>Industry Personnel</option>
			</select><br>
			</div>
		</div>
		...
		<div class="row content">
			...
			<input type="number" class="form-control" name="noofparticipants" required="required" placeholder="" /> <br>
			</div>
		</div>
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Venue </label><br>
			<input type="text" class="form-control" name="nameoffaculty" required="required" placeholder="" /> <br>
			</div>
		</div>
		
		<div class="row content">
			<div class="col-md-6 ">
				<label><font style="color: red;">*</font>Programmme Date</label><br>
			<input type="text" class="form-control" name="programdate" required="required" placeholder="" /> <br>
			</div>
		</div>
