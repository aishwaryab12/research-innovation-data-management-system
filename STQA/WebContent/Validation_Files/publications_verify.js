function validate()
{
	var citationCount= document.forms["publication_form"]["citationCount"];
	//
	var fromPage= document.forms["publication_form"]["fromPage"];
	var toPage= document.forms["publication_form"]["toPage"];
